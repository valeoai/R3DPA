...
accelerate launch train_repae.py \
    ...
    --bn-momentum=0.1 \
    --exp-name="vae-align-sit-b-2-h2p4d8-b32" \
    --num-classes=1 \
    --resolution 64 1024 \
    ...
    --tuning \
    --train-vae-only \
    --sit-ckpt="log/training/sit-b-2-dinov2-b-enc4-ldm-only-e2e-sdvae-0.5-4m-imagenet-uncond/checkpoints/1000000.pt" \
    --learning-rate=1e-4 \
